...
public class UserService {
	...
	public Response register(User user) {
		if(user.getEmail_address().isEmpty()||user.getUsername().isEmpty()||user.getPassword().isEmpty())
			{return new Response(false);}
		else 
		{	
		User existingUser=userDao.findByUsername(user.getUsername());
		if (existingUser!=null) {return new Response(false,"username have been used");}
